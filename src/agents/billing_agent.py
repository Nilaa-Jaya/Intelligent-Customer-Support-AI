...
def handle_billing(state: AgentState) -> AgentState:
    ...
    try:
        ...
        if any(word in query_lower for word in ["refund", "dispute", "chargeback", "cancel subscription"]):
        ...
        state["response"] = "I apologize for the inconvenience. For billing matters, please contact our billing department directly for immediate assistance."
