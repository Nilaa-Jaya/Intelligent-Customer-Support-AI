"""
Main customer support orchestrator
"""
...
from src.database import (
    get_db_context, UserQueries, ConversationQueries,
    MessageQueries
)
from src.utils import (
    app_logger, generate_conversation_id,
    format_response, Timer
)
...
class CustomerSupportAgent:
    ...
    def process_query(
        ...
        try:
            ...
            with get_db_context() as db:
                ...
                recent_convs = ConversationQueries.get_user_conversations(db, user.id, limit=5)
                ...
                repeat_count = ConversationQueries.get_repeat_query_count(
                    db, user.id, "Technical"  # We'll update this after categorization
                )
                ...
                user_context["is_repeat_query"] = repeat_count > 0
                user_context["attempt_count"] = repeat_count + 1
            ...
            with get_db_context() as db:
                ...
                MessageQueries.add_message(db, conversation.id, "assistant", result.get("response", ""))
    ...
    def get_conversation_history(
        ...
        with get_db_context() as db:
            ...
            conversations = ConversationQueries.get_user_conversations(db, user.id, limit)
